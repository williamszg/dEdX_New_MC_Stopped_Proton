...
#ifndef ProtonMCNew_0_1000_h
#define ProtonMCNew_0_1000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ProtonMCNew_0_1000(TTree *tree=0);
   virtual ~ProtonMCNew_0_1000();
...
#ifdef ProtonMCNew_0_1000_cxx
ProtonMCNew_0_1000::ProtonMCNew_0_1000(TTree *tree) : fChain(0) 
{
...
ProtonMCNew_0_1000::~ProtonMCNew_0_1000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProtonMCNew_0_1000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonMCNew_0_1000::LoadTree(Long64_t entry)
{
...
void ProtonMCNew_0_1000::Init(TTree *tree)
{
...
Bool_t ProtonMCNew_0_1000::Notify()
{
...
void ProtonMCNew_0_1000::Show(Long64_t entry)
{
...
Int_t ProtonMCNew_0_1000::Cut(Long64_t entry)
{
