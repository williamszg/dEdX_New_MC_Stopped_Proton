...
// Thu Jun 29 12:30:31 2017 by ROOT version 6.06/08
// from TTree anatree/analysis tree
// found on file: /lariat/data/users/jasaadi/v06_34_01/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef DataProtonRunII_h
#define DataProtonRunII_h
...
class MPVRunIIDataProtonStopped {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[420];   //[nclus]
   Double_t        clusterttick[420];   //[nclus]
   Double_t        cluendwire[420];   //[nclus]
   Double_t        cluendtick[420];   //[nclus]
   Int_t           cluplane[420];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[89];   //[ntracks_reco]
   Double_t        trkvtxy[89];   //[ntracks_reco]
   Double_t        trkvtxz[89];   //[ntracks_reco]
   Double_t        trkendx[89];   //[ntracks_reco]
   Double_t        trkendy[89];   //[ntracks_reco]
   Double_t        trkendz[89];   //[ntracks_reco]
   Double_t        trkstartdcosx[89];   //[ntracks_reco]
   Double_t        trkstartdcosy[89];   //[ntracks_reco]
   Double_t        trkstartdcosz[89];   //[ntracks_reco]
   Double_t        trkenddcosx[89];   //[ntracks_reco]
   Double_t        trkenddcosy[89];   //[ntracks_reco]
   Double_t        trkenddcosz[89];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[89];   //[ntracks_reco]
   Double_t        trklength[89];   //[ntracks_reco]
   Double_t        trkmomrange[89];   //[ntracks_reco]
   Double_t        trkmommschi2[89];   //[ntracks_reco]
   Double_t        trkmommsllhd[89];   //[ntracks_reco]
   Int_t           ntrkhits[89];   //[ntracks_reco]
   Double_t        trkx[89][1000];   //[ntracks_reco]
   Double_t        trky[89][1000];   //[ntracks_reco]
   Double_t        trkz[89][1000];   //[ntracks_reco]
   Double_t        trkpitch[89][2];   //[ntracks_reco]
   Int_t           trkhits[89][2];   //[ntracks_reco]
   Double_t        trkdedx[89][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[89][2][1000];   //[ntracks_reco]
   Double_t        trkrr[89][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[89][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[89][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[89][2];   //[ntracks_reco]
   Double_t        trkpida[89][2];   //[ntracks_reco]
   Int_t           nTrajPoint[89];   //[ntracks_reco]
   Double_t        pHat0_X[89][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[89][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[89][1000];   //[ntracks_reco]
   Double_t        trjPt_X[89][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[89][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[89][1000];   //[ntracks_reco]
   Int_t           trkg4id[89];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[16241];   //[nhits]
   Int_t           hit_wire[16241];   //[nhits]
   Int_t           hit_channel[16241];   //[nhits]
   Double_t        hit_peakT[16241];   //[nhits]
   Double_t        hit_charge[16241];   //[nhits]
   Double_t        hit_ph[16241];   //[nhits]
   Double_t        hit_tstart[16241];   //[nhits]
   Double_t        hit_tend[16241];   //[nhits]
   Int_t           hit_trkid[16241];   //[nhits]
   Int_t           hit_trkkey[16241];   //[nhits]
   Int_t           hit_clukey[16241];   //[nhits]
   Int_t           hit_pk[16241];   //[nhits]
   Int_t           hit_t[16241];   //[nhits]
   Int_t           hit_ch[16241];   //[nhits]
   Int_t           hit_fwhh[16241];   //[nhits]
   Double_t        hit_rms[16241];   //[nhits]
   Double_t        hit_nelec[16241];   //[nhits]
   Double_t        hit_energy[16241];   //[nhits]
   Float_t         hit_dQds[16241];   //[nhits]
   Float_t         hit_dEds[16241];   //[nhits]
   Float_t         hit_ds[16241];   //[nhits]
   Float_t         hit_resrange[16241];   //[nhits]
   Float_t         hit_x[16241];   //[nhits]
   Float_t         hit_y[16241];   //[nhits]
   Float_t         hit_z[16241];   //[nhits]
   Int_t           nwctrks;
   ...
   MPVRunIIDataProtonStopped(TTree *tree=0);
   virtual ~MPVRunIIDataProtonStopped();
...
#ifdef MPVRunIIDataProtonStopped_cxx
MPVRunIIDataProtonStopped::MPVRunIIDataProtonStopped(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
MPVRunIIDataProtonStopped::~MPVRunIIDataProtonStopped()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MPVRunIIDataProtonStopped::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MPVRunIIDataProtonStopped::LoadTree(Long64_t entry)
{
...
void MPVRunIIDataProtonStopped::Init(TTree *tree)
{
...
Bool_t MPVRunIIDataProtonStopped::Notify()
{
...
void MPVRunIIDataProtonStopped::Show(Long64_t entry)
{
...
Int_t MPVRunIIDataProtonStopped::Cut(Long64_t entry)
{
