...
// Thu Oct 19 23:28:44 2017 by ROOT version 6.08/06
// from TTree anatree/analysis tree
// found on file: NewMCMapMethod_0_1000.root
//////////////////////////////////////////////////////////

#ifndef NewMCMap_0_1000_h
#define NewMCMap_0_1000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[26];   //[nclus]
   Double_t        clusterttick[26];   //[nclus]
   Double_t        cluendwire[26];   //[nclus]
   Double_t        cluendtick[26];   //[nclus]
   Int_t           cluplane[26];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[8];   //[ntracks_reco]
   Double_t        trkvtxy[8];   //[ntracks_reco]
   Double_t        trkvtxz[8];   //[ntracks_reco]
   Double_t        trkendx[8];   //[ntracks_reco]
   Double_t        trkendy[8];   //[ntracks_reco]
   Double_t        trkendz[8];   //[ntracks_reco]
   Double_t        trkstartdcosx[8];   //[ntracks_reco]
   Double_t        trkstartdcosy[8];   //[ntracks_reco]
   Double_t        trkstartdcosz[8];   //[ntracks_reco]
   Double_t        trkenddcosx[8];   //[ntracks_reco]
   Double_t        trkenddcosy[8];   //[ntracks_reco]
   Double_t        trkenddcosz[8];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[8];   //[ntracks_reco]
   Double_t        trklength[8];   //[ntracks_reco]
   Double_t        trkmomrange[8];   //[ntracks_reco]
   Double_t        trkmommschi2[8];   //[ntracks_reco]
   Double_t        trkmommsllhd[8];   //[ntracks_reco]
   Int_t           ntrkhits[8];   //[ntracks_reco]
   Double_t        trkx[8][1000];   //[ntracks_reco]
   Double_t        trky[8][1000];   //[ntracks_reco]
   Double_t        trkz[8][1000];   //[ntracks_reco]
   Double_t        trkpitch[8][2];   //[ntracks_reco]
   Int_t           trkhits[8][2];   //[ntracks_reco]
   Double_t        trkdedx[8][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[8][2][1000];   //[ntracks_reco]
   Double_t        trkrr[8][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[8][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[8][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[8][2];   //[ntracks_reco]
   Double_t        trkpida[8][2];   //[ntracks_reco]
   Int_t           nTrajPoint[8];   //[ntracks_reco]
   Double_t        pHat0_X[8][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[8][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[8][1000];   //[ntracks_reco]
   Double_t        trjPt_X[8][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[8][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[8][1000];   //[ntracks_reco]
   Int_t           trkg4id[8];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[361];   //[nhits]
   Int_t           hit_wire[361];   //[nhits]
   Int_t           hit_channel[361];   //[nhits]
   Double_t        hit_peakT[361];   //[nhits]
   Double_t        hit_charge[361];   //[nhits]
   Double_t        hit_ph[361];   //[nhits]
   Double_t        hit_tstart[361];   //[nhits]
   Double_t        hit_tend[361];   //[nhits]
   Int_t           hit_trkid[361];   //[nhits]
   Int_t           hit_trkkey[361];   //[nhits]
   Int_t           hit_clukey[361];   //[nhits]
   Int_t           hit_pk[361];   //[nhits]
   Int_t           hit_t[361];   //[nhits]
   Int_t           hit_ch[361];   //[nhits]
   Int_t           hit_fwhh[361];   //[nhits]
   Double_t        hit_rms[361];   //[nhits]
   Double_t        hit_nelec[361];   //[nhits]
   Double_t        hit_energy[361];   //[nhits]
   Float_t         hit_dQds[361];   //[nhits]
   Float_t         hit_dEds[361];   //[nhits]
   Float_t         hit_ds[361];   //[nhits]
   Float_t         hit_resrange[361];   //[nhits]
   Float_t         hit_x[361];   //[nhits]
   Float_t         hit_y[361];   //[nhits]
   Float_t         hit_z[361];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2995];   //[maxTrackIDE]
   Double_t        IDEPos[2995][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[155];   //[geant_list_size]
   Double_t        Eng[155];   //[geant_list_size]
   Double_t        Px[155];   //[geant_list_size]
   Double_t        Py[155];   //[geant_list_size]
   Double_t        Pz[155];   //[geant_list_size]
   Double_t        EndEng[155];   //[geant_list_size]
   Double_t        EndPx[155];   //[geant_list_size]
   Double_t        EndPy[155];   //[geant_list_size]
   Double_t        EndPz[155];   //[geant_list_size]
   Double_t        StartPointx[155];   //[geant_list_size]
   Double_t        StartPointy[155];   //[geant_list_size]
   Double_t        StartPointz[155];   //[geant_list_size]
   Double_t        EndPointx[155];   //[geant_list_size]
   Double_t        EndPointy[155];   //[geant_list_size]
   Double_t        EndPointz[155];   //[geant_list_size]
   Int_t           Process[155];   //[geant_list_size]
   Int_t           NumberDaughters[155];   //[geant_list_size]
   Int_t           Mother[155];   //[geant_list_size]
   Int_t           TrackId[155];   //[geant_list_size]
   Int_t           process_primary[155];   //[geant_list_size]
   ...
   NewMCMap_0_1000(TTree *tree=0);
   virtual ~NewMCMap_0_1000();
...
#ifdef NewMCMap_0_1000_cxx
NewMCMap_0_1000::NewMCMap_0_1000(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f || !f->IsOpen()) {
         f = new TFile("NewMCMapMethod_0_1000.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("NewMCMapMethod_0_1000.root:/anatree");
...
NewMCMap_0_1000::~NewMCMap_0_1000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewMCMap_0_1000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewMCMap_0_1000::LoadTree(Long64_t entry)
{
...
void NewMCMap_0_1000::Init(TTree *tree)
{
...
void NewMCMap_0_1000::Show(Long64_t entry)
{
...
Int_t NewMCMap_0_1000::Cut(Long64_t entry)
{
...
#endif // #ifdef NewMCMap_0_1000_cxx
