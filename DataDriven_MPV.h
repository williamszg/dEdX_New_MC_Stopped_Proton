...
// Mon Jun 19 10:45:54 2017 by ROOT version 6.06/08
...
#ifndef DataDriven_MPV_h
#define DataDriven_MPV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[39];   //[nclus]
   Double_t        clusterttick[39];   //[nclus]
   Double_t        cluendwire[39];   //[nclus]
   Double_t        cluendtick[39];   //[nclus]
   Int_t           cluplane[39];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[12];   //[ntracks_reco]
   Double_t        trkvtxy[12];   //[ntracks_reco]
   Double_t        trkvtxz[12];   //[ntracks_reco]
   Double_t        trkendx[12];   //[ntracks_reco]
   Double_t        trkendy[12];   //[ntracks_reco]
   Double_t        trkendz[12];   //[ntracks_reco]
   Double_t        trkstartdcosx[12];   //[ntracks_reco]
   Double_t        trkstartdcosy[12];   //[ntracks_reco]
   Double_t        trkstartdcosz[12];   //[ntracks_reco]
   Double_t        trkenddcosx[12];   //[ntracks_reco]
   Double_t        trkenddcosy[12];   //[ntracks_reco]
   Double_t        trkenddcosz[12];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[12];   //[ntracks_reco]
   Double_t        trklength[12];   //[ntracks_reco]
   Double_t        trkmomrange[12];   //[ntracks_reco]
   Double_t        trkmommschi2[12];   //[ntracks_reco]
   Double_t        trkmommsllhd[12];   //[ntracks_reco]
   Int_t           ntrkhits[12];   //[ntracks_reco]
   Double_t        trkx[12][1000];   //[ntracks_reco]
   Double_t        trky[12][1000];   //[ntracks_reco]
   Double_t        trkz[12][1000];   //[ntracks_reco]
   Double_t        trkpitch[12][2];   //[ntracks_reco]
   Int_t           trkhits[12][2];   //[ntracks_reco]
   Double_t        trkdedx[12][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[12][2][1000];   //[ntracks_reco]
   Double_t        trkrr[12][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[12][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[12][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[12][2];   //[ntracks_reco]
   Double_t        trkpida[12][2];   //[ntracks_reco]
   Int_t           nTrajPoint[12];   //[ntracks_reco]
   Double_t        pHat0_X[12][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[12][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[12][1000];   //[ntracks_reco]
   Double_t        trjPt_X[12][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[12][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[12][1000];   //[ntracks_reco]
   Int_t           trkg4id[12];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[689];   //[nhits]
   Int_t           hit_wire[689];   //[nhits]
   Int_t           hit_channel[689];   //[nhits]
   Double_t        hit_peakT[689];   //[nhits]
   Double_t        hit_charge[689];   //[nhits]
   Double_t        hit_ph[689];   //[nhits]
   Double_t        hit_tstart[689];   //[nhits]
   Double_t        hit_tend[689];   //[nhits]
   Int_t           hit_trkid[689];   //[nhits]
   Int_t           hit_trkkey[689];   //[nhits]
   Int_t           hit_clukey[689];   //[nhits]
   Int_t           hit_pk[689];   //[nhits]
   Int_t           hit_t[689];   //[nhits]
   Int_t           hit_ch[689];   //[nhits]
   Int_t           hit_fwhh[689];   //[nhits]
   Double_t        hit_rms[689];   //[nhits]
   Double_t        hit_nelec[689];   //[nhits]
   Double_t        hit_energy[689];   //[nhits]
   Float_t         hit_dQds[689];   //[nhits]
   Float_t         hit_dEds[689];   //[nhits]
   Float_t         hit_ds[689];   //[nhits]
   Float_t         hit_resrange[689];   //[nhits]
   Float_t         hit_x[689];   //[nhits]
   Float_t         hit_y[689];   //[nhits]
   Float_t         hit_z[689];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2366];   //[maxTrackIDE]
   Double_t        IDEPos[2366][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[162];   //[geant_list_size]
   Double_t        Eng[162];   //[geant_list_size]
   Double_t        Px[162];   //[geant_list_size]
   Double_t        Py[162];   //[geant_list_size]
   Double_t        Pz[162];   //[geant_list_size]
   Double_t        EndEng[162];   //[geant_list_size]
   Double_t        EndPx[162];   //[geant_list_size]
   Double_t        EndPy[162];   //[geant_list_size]
   Double_t        EndPz[162];   //[geant_list_size]
   Double_t        StartPointx[162];   //[geant_list_size]
   Double_t        StartPointy[162];   //[geant_list_size]
   Double_t        StartPointz[162];   //[geant_list_size]
   Double_t        EndPointx[162];   //[geant_list_size]
   Double_t        EndPointy[162];   //[geant_list_size]
   Double_t        EndPointz[162];   //[geant_list_size]
   Int_t           Process[162];   //[geant_list_size]
   Int_t           NumberDaughters[162];   //[geant_list_size]
   Int_t           Mother[162];   //[geant_list_size]
   Int_t           TrackId[162];   //[geant_list_size]
   Int_t           process_primary[162];   //[geant_list_size]
   ...
   DataDriven_MPV(TTree *tree=0);
   virtual ~DataDriven_MPV();
...
#ifdef DataDriven_MPV_cxx
DataDriven_MPV::DataDriven_MPV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/data/users/jasaadi/DataDriven_MonteCarloSamples_AnaTreeFiles/ProtonRunI_DDMC_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/data/users/jasaadi/DataDriven_MonteCarloSamples_AnaTreeFiles/ProtonRunI_DDMC_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/data/users/jasaadi/DataDriven_MonteCarloSamples_AnaTreeFiles/ProtonRunI_DDMC_AnaTree.root:/anatree");
...
DataDriven_MPV::~DataDriven_MPV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DataDriven_MPV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataDriven_MPV::LoadTree(Long64_t entry)
{
...
void DataDriven_MPV::Init(TTree *tree)
{
...
void DataDriven_MPV::Show(Long64_t entry)
{
...
Int_t DataDriven_MPV::Cut(Long64_t entry)
{
