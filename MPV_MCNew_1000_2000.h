...
#ifndef MPV_MCNew_1000_2000_h
#define MPV_MCNew_1000_2000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MPV_MCNew_1000_2000(TTree *tree=0);
   virtual ~MPV_MCNew_1000_2000();
...
#ifdef MPV_MCNew_1000_2000_cxx
MPV_MCNew_1000_2000::MPV_MCNew_1000_2000(TTree *tree) : fChain(0) 
{
...
MPV_MCNew_1000_2000::~MPV_MCNew_1000_2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MPV_MCNew_1000_2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MPV_MCNew_1000_2000::LoadTree(Long64_t entry)
{
...
void MPV_MCNew_1000_2000::Init(TTree *tree)
{
...
Bool_t MPV_MCNew_1000_2000::Notify()
{
...
void MPV_MCNew_1000_2000::Show(Long64_t entry)
{
...
Int_t MPV_MCNew_1000_2000::Cut(Long64_t entry)
{
