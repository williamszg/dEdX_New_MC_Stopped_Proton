...
#ifndef DataProtonRunI_h
#define DataProtonRunI_h
...
class MPVRunIDataProtonStopped {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MPVRunIDataProtonStopped(TTree *tree=0);
   virtual ~MPVRunIDataProtonStopped();
...
#ifdef MPVRunIDataProtonStopped_cxx
MPVRunIDataProtonStopped::MPVRunIDataProtonStopped(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/data/users/jasaadi/v06_34_01/UpdatedCaloConstants_August2017/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
MPVRunIDataProtonStopped::~MPVRunIDataProtonStopped()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MPVRunIDataProtonStopped::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MPVRunIDataProtonStopped::LoadTree(Long64_t entry)
{
...
void MPVRunIDataProtonStopped::Init(TTree *tree)
{
...
Bool_t MPVRunIDataProtonStopped::Notify()
{
...
void MPVRunIDataProtonStopped::Show(Long64_t entry)
{
...
Int_t MPVRunIDataProtonStopped::Cut(Long64_t entry)
{
