#define MPVRunIIDataProtonStopped_cxx
#include "DataProtonRunII.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TRandom.h>
...
TH1D *hMPVEnergyLossUpstream = new TH1D("hMPVEnergyLossUpstream", "MPV value for the energy lost upstream on RunII", 1000, 0, 200);
...
void MPVRunIIDataProtonStopped::Loop()
{
if (fChain == 0) return;
...
TFile myfile("./ROOTFILES/RunIIPosPolData_StoppingProtons_MPV.root", "RECREATE");
