...
// Thu Oct 19 23:36:28 2017 by ROOT version 6.08/06
// from TTree anatree/analysis tree
// found on file: NewMCMapMethod_1000_2000.root
//////////////////////////////////////////////////////////

#ifndef NewMCMap_1000_2000_h
#define NewMCMap_1000_2000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[67];   //[nclus]
   Double_t        clusterttick[67];   //[nclus]
   Double_t        cluendwire[67];   //[nclus]
   Double_t        cluendtick[67];   //[nclus]
   Int_t           cluplane[67];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[21];   //[ntracks_reco]
   Double_t        trkvtxy[21];   //[ntracks_reco]
   Double_t        trkvtxz[21];   //[ntracks_reco]
   Double_t        trkendx[21];   //[ntracks_reco]
   Double_t        trkendy[21];   //[ntracks_reco]
   Double_t        trkendz[21];   //[ntracks_reco]
   Double_t        trkstartdcosx[21];   //[ntracks_reco]
   Double_t        trkstartdcosy[21];   //[ntracks_reco]
   Double_t        trkstartdcosz[21];   //[ntracks_reco]
   Double_t        trkenddcosx[21];   //[ntracks_reco]
   Double_t        trkenddcosy[21];   //[ntracks_reco]
   Double_t        trkenddcosz[21];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[21];   //[ntracks_reco]
   Double_t        trklength[21];   //[ntracks_reco]
   Double_t        trkmomrange[21];   //[ntracks_reco]
   Double_t        trkmommschi2[21];   //[ntracks_reco]
   Double_t        trkmommsllhd[21];   //[ntracks_reco]
   Int_t           ntrkhits[21];   //[ntracks_reco]
   Double_t        trkx[21][1000];   //[ntracks_reco]
   Double_t        trky[21][1000];   //[ntracks_reco]
   Double_t        trkz[21][1000];   //[ntracks_reco]
   Double_t        trkpitch[21][2];   //[ntracks_reco]
   Int_t           trkhits[21][2];   //[ntracks_reco]
   Double_t        trkdedx[21][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[21][2][1000];   //[ntracks_reco]
   Double_t        trkrr[21][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[21][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[21][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[21][2];   //[ntracks_reco]
   Double_t        trkpida[21][2];   //[ntracks_reco]
   Int_t           nTrajPoint[21];   //[ntracks_reco]
   Double_t        pHat0_X[21][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[21][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[21][1000];   //[ntracks_reco]
   Double_t        trjPt_X[21][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[21][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[21][1000];   //[ntracks_reco]
   Int_t           trkg4id[21];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1082];   //[nhits]
   Int_t           hit_wire[1082];   //[nhits]
   Int_t           hit_channel[1082];   //[nhits]
   Double_t        hit_peakT[1082];   //[nhits]
   Double_t        hit_charge[1082];   //[nhits]
   Double_t        hit_ph[1082];   //[nhits]
   Double_t        hit_tstart[1082];   //[nhits]
   Double_t        hit_tend[1082];   //[nhits]
   Int_t           hit_trkid[1082];   //[nhits]
   Int_t           hit_trkkey[1082];   //[nhits]
   Int_t           hit_clukey[1082];   //[nhits]
   Int_t           hit_pk[1082];   //[nhits]
   Int_t           hit_t[1082];   //[nhits]
   Int_t           hit_ch[1082];   //[nhits]
   Int_t           hit_fwhh[1082];   //[nhits]
   Double_t        hit_rms[1082];   //[nhits]
   Double_t        hit_nelec[1082];   //[nhits]
   Double_t        hit_energy[1082];   //[nhits]
   Float_t         hit_dQds[1082];   //[nhits]
   Float_t         hit_dEds[1082];   //[nhits]
   Float_t         hit_ds[1082];   //[nhits]
   Float_t         hit_resrange[1082];   //[nhits]
   Float_t         hit_x[1082];   //[nhits]
   Float_t         hit_y[1082];   //[nhits]
   Float_t         hit_z[1082];   //[nhits]
   Int_t           nwctrks;
   ...
   Float_t         WCTrackResidual[1];   //[nwctrks]
   Int_t           WCTrackWCMissed[1];   //[nwctrks]
   Int_t           ntof;
   Double_t        tofObject[1];   //[ntof]
   Float_t         wcP[1];   //[nwctrks]
   Float_t         wcPx[1];   //[nwctrks]
   Float_t         wcPy[1];   //[nwctrks]
   Float_t         wcPz[1];   //[nwctrks]
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3736];   //[maxTrackIDE]
   Double_t        IDEPos[3736][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[325];   //[geant_list_size]
   Double_t        Eng[325];   //[geant_list_size]
   Double_t        Px[325];   //[geant_list_size]
   Double_t        Py[325];   //[geant_list_size]
   Double_t        Pz[325];   //[geant_list_size]
   Double_t        EndEng[325];   //[geant_list_size]
   Double_t        EndPx[325];   //[geant_list_size]
   Double_t        EndPy[325];   //[geant_list_size]
   Double_t        EndPz[325];   //[geant_list_size]
   Double_t        StartPointx[325];   //[geant_list_size]
   Double_t        StartPointy[325];   //[geant_list_size]
   Double_t        StartPointz[325];   //[geant_list_size]
   Double_t        EndPointx[325];   //[geant_list_size]
   Double_t        EndPointy[325];   //[geant_list_size]
   Double_t        EndPointz[325];   //[geant_list_size]
   Int_t           Process[325];   //[geant_list_size]
   Int_t           NumberDaughters[325];   //[geant_list_size]
   Int_t           Mother[325];   //[geant_list_size]
   Int_t           TrackId[325];   //[geant_list_size]
   Int_t           process_primary[325];   //[geant_list_size]
   ...
   TBranch        *b_WC4yPos;   //!
   TBranch        *b_WC4zPos;   //!
   TBranch        *b_WCTrackResidual;   //!
   TBranch        *b_WCTrackWCMissed;   //!
   TBranch        *b_ntof;   //!
   TBranch        *b_tofObject;   //!
   TBranch        *b_wcP;   //!
   TBranch        *b_wcPx;   //!
   ...
   NewMCMap_1000_2000(TTree *tree=0);
   virtual ~NewMCMap_1000_2000();
...
#ifdef NewMCMap_1000_2000_cxx
NewMCMap_1000_2000::NewMCMap_1000_2000(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f || !f->IsOpen()) {
         f = new TFile("NewMCMapMethod_1000_2000.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("NewMCMapMethod_1000_2000.root:/anatree");
...
NewMCMap_1000_2000::~NewMCMap_1000_2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t NewMCMap_1000_2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NewMCMap_1000_2000::LoadTree(Long64_t entry)
{
...
void NewMCMap_1000_2000::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("WCTrackResidual", &WCTrackResidual, &b_WCTrackResidual);
   fChain->SetBranchAddress("WCTrackWCMissed", &WCTrackWCMissed, &b_WCTrackWCMissed);
   fChain->SetBranchAddress("ntof", &ntof, &b_ntof);
   fChain->SetBranchAddress("tofObject", &tofObject, &b_tofObject);
   fChain->SetBranchAddress("wcP", &wcP, &b_wcP);
   fChain->SetBranchAddress("wcPx", &wcPx, &b_wcPx);
   fChain->SetBranchAddress("wcPy", &wcPy, &b_wcPy);
   fChain->SetBranchAddress("wcPz", &wcPz, &b_wcPz);
   fChain->SetBranchAddress("tof_timestamp", &tof_timestamp, &b_tof_timestamp);
   fChain->SetBranchAddress("cTOF", &cTOF, &b_cTOF);
   fChain->SetBranchAddress("mass", &mass, &b_massObj);
...
Bool_t NewMCMap_1000_2000::Notify()
{
...
void NewMCMap_1000_2000::Show(Long64_t entry)
{
...
Int_t NewMCMap_1000_2000::Cut(Long64_t entry)
{
...
#endif // #ifdef NewMCMap_1000_2000_cxx
